...
control.prototype.drawHero = function (status, offset) {
    ...
    core.bigmap.offsetX = 32; // core.clamp((x - core.__HALF_SIZE__) * 32 + offsetX, 0, 32*core.bigmap.width-core.__PIXELS__);
    core.bigmap.offsetY = 32; // core.clamp((y - core.__HALF_SIZE__) * 32 + offsetY, 0, 32*core.bigmap.height-core.__PIXELS__);
...
control.prototype.resize = function() {
    ...
    var CANVAS_WIDTH = core.__PIXELS__, BAR_WIDTH = 125;
    var borderWidth = 19, borderHeight = 24, infoBarHeight = 22;
    var totalWidth = CANVAS_WIDTH + (BAR_WIDTH + borderWidth) * 2;
    var totalHeight = CANVAS_WIDTH + borderHeight * 2 + infoBarHeight;
    
    core.domStyle.isVertical = false;
    core.domStyle.scale = Math.min(1, clientHeight / totalHeight, clientWidth / totalWidth);
    ...
    var obj = {
        ...
        totalHeight: totalHeight * core.domStyle.scale,
        totalWidth: totalWidth * core.domStyle.scale
    };
...
control.prototype._resize_gameGroup = function (obj) {
    ...
    if (core.domStyle.isVertical) {
        core.dom.gameGroup.style.transform = "rotate(90deg)";
    } else {
        core.dom.gameGroup.style.transform = "";
    }
}

control.prototype._resize_canvas = function (obj) {
    var innerSize = (obj.outerSize) + "px";
    core.dom.data.style.width = obj.totalWidth + "px";
    core.dom.data.style.height = obj.totalHeight + "px";
    document.getElementById("outerBackground").style.width = obj.totalWidth + "px";
    document.getElementById("outerBackground").style.height = obj.totalHeight + "px";
    ...
    core.dom.gameDraw.style.right = (obj.borderWidth + obj.BAR_WIDTH + 1) * core.domStyle.scale + "px";
    // resize bigmap
    core.bigmap.canvas.forEach(function(cn){
    ...
    if (core.isPlaying()) this.updateViewport();
