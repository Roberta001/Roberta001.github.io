var items_296f5d02_12fd_4166_a7c1_b5e830c9ee3a = 
{
	...
	"itemEffect": {
		"redJewel": "core.status.hero.atk += core.values.redJewel * Math.ceil(core.status.floorId.replace(/[^0-9]/ig, \"\") / 10);",
		"blueJewel": "core.status.hero.def += core.values.blueJewel * Math.ceil(core.status.floorId.replace(/[^0-9]/ig, \"\") / 10);",
		...
		"redPotion": "core.status.hero.hp += core.values.redPotion * Math.ceil(core.status.floorId.replace(/[^0-9]/ig, \"\") / 10);",
		"bluePotion": "core.status.hero.hp += core.values.bluePotion * Math.ceil(core.status.floorId.replace(/[^0-9]/ig, \"\") / 10);",
		...
		"sword1": "core.status.hero.atk += 10, core.setFlag('nowWeapon', 'sword1')",
		"sword2": "core.status.hero.atk += 20, core.setFlag('nowWeapon', 'sword2')",
		"sword3": "core.status.hero.atk += 40, core.setFlag('nowWeapon', 'sword3')",
		"sword4": "core.status.hero.atk += 50, core.setFlag('nowWeapon', 'sword4')",
		"sword5": "core.status.hero.atk += 100, core.setFlag('nowWeapon', 'sword5')",
		"shield0": "core.status.hero.def += 0",
		"shield1": "core.status.hero.def += 10, core.setFlag('nowShield', 'shield1')",
		"shield2": "core.status.hero.def += 20, core.setFlag('nowShield', 'shield2')",
		"shield3": "core.status.hero.def += 40, core.setFlag('nowShield', 'shield3')",
		"shield4": "core.status.hero.def += 50, core.setFlag('nowShield', 'shield4')",
		"shield5": "core.status.hero.def += 100, core.setFlag('nowShield', 'shield5');\ncore.setFlag('shield5', 1);",
	...
	"itemEffectTip": {
		"redJewel": "'，提升 ' + core.values.redJewel * Math.ceil(core.status.floorId.replace(/[^0-9]/ig, \"\") / 10) + ' 点攻击';",
		"blueJewel": "'，提升 ' + core.values.blueJewel * Math.ceil(core.status.floorId.replace(/[^0-9]/ig, \"\") / 10) + ' 点防御';",
		"greenJewel": "'，魔防+'+core.values.greenJewel * ratio",
		"yellowJewel": "'，全属性提升'",
		"redPotion": "'，提升 ' + core.values.redPotion * Math.ceil(core.status.floorId.replace(/[^0-9]/ig, \"\") / 10) + ' 点生命';",
		"bluePotion": "'，提升 ' + core.values.bluePotion * Math.ceil(core.status.floorId.replace(/[^0-9]/ig, \"\") / 10) + ' 点生命';",
